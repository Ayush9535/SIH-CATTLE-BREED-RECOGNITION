      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.breedsSection}>
          ...
          <View style={styles.breedTags}>
            {[t('breeds.gir'), t('breeds.sahiwal'), t('breeds.redSindhi'), t('breeds.tharparkar'), t('breeds.rathi'), t('breeds.kankrej'),
            t('breeds.ongole'), t('breeds.hariana'), t('breeds.kangayam'), t('breeds.hallikar'), t('breeds.khillari'), t('breeds.deoni')].map((breed, index) => (
